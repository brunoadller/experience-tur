  ...
  return(
    <div className="max-w-[1400px] h-[500px] bg-blue-100 mx-auto my-20 pt-16 lg:mb-[20%] md:mb-[35%] px-4 grid lg:grid-cols-3 gap-4">
      <div className="lg:top-20 relative lg:col-span-1 col-span-2">
        <h3 className="tex-2xl font-bold">Ótimos Quartos Interirores</h3>
        <p className="pt-4">
        Temos as melhores opções em suítes, diárias, pacotes com decoração, pernoites, day-use. 
        Portanto não se esqueça que a melhor forma de fazer sua reserva é conversando diretamente com você. Por outro lado, 
        você pode garantir um super desconto.
        </p>
      </div>
